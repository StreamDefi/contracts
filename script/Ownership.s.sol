...
contract TransferOwnership is Script {
    ...
    function run() public {
        ...
        VaultKeeper vaultKeeper = VaultKeeper(
            0x7012DaAB8D34a6f415b2EAac3b75565592d1B09e
        );
        ...
        vaultKeeper.transferOwnership("USDC", owner);
        vaultKeeper.transferOwnership("WBTC", owner);
        vaultKeeper.transferOwnership("WETH", owner);
