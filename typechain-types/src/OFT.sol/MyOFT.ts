...
export interface MyOFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "SEND"
      | "SEND_AND_CALL"
...
export interface MyOFT extends BaseContract {
  connect(runner?: ContractRunner | null): MyOFT;
  waitForDeployment(): Promise<this>;

  interface: MyOFTInterface;
